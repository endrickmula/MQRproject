...
const Signup = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("https://endrick.alwaysdata.net/api/signup", data);
    ...
    return (
        <div className="row justify-content-center mt-4">
            <div className="col-md-6 card shadow p-4 bg-dark">
                <h2 className="text-primary bg-secondary">Sign Up</h2>
                ...
                Already have an account ?<Link to="/signin" bg-secondary>Sign In</Link>
            </div>
        </div>
    );
};
